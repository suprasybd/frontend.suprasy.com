...
import { Button } from '@customer/components/selectors/Button';
import { Custom1, OnlyButtons } from '@customer/components/selectors/Custom1';
import {
  Custom2,
  Custom2VideoDrop,
} from '@customer/components/selectors/Custom2';
import {
  Custom3,
  Custom3BtnDrop,
